...
export default function GameOver({ 
  ...
  const shareText = `I just scored ${score}/${totalQuestions} (${percentage}%) on BrainTease ${difficulty} difficulty! Can you beat my score?`;
  
  const shareToTwitter = () => {
    const url = `https://twitter.com/intent/tweet?text=${encodeURIComponent(shareText)}&hashtags=BrainTease,Trivia,Quiz`;
    ...
    <div className="game-over-container">
      <div className="game-over-card">
        ...
        <div className="score-section">
          <h2 className="performance-message">{getPerformanceMessage()}</h2>
          ...
          <div className="difficulty-badge">
            ...
            <span className={`difficulty-value difficulty-${difficulty}`}>
