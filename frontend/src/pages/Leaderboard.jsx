...
export default function Leaderboard() {
  ...
  return (
    <div style={{ 
      ...
      margin: '0 auto', 
      padding: '20px',
      marginTop: '20px'   // ⭐ Moved ENTIRE layout 20px downward
    }}>
      {/* Header */}
      ...
      {displayData.length === 0 ? (
        ...
        <div style={{ 
          ...
          {displayData.map((entry, index) => {
            ...
            if (index === 0) { rankIcon = '🥇'; rankColor = '#FFD700'; }
            else if (index === 1) { rankIcon = '🥈'; rankColor = '#C0C0C0'; }
            else if (index === 2) { rankIcon = '🥉'; rankColor = '#CD7F32'; }
